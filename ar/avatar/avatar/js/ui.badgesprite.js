...
UI.BadgeSprite.prototype.draw = function(params){
	...
	if(params.role.toLowerCase() === 'developer'){
		iconObject.src = 'avatar/role-icons/developer.png';
	}else if(params.role.toLowerCase() === 'designer'){
		iconObject.src = 'avatar/role-icons/designer.png';
	}else if(params.role.toLowerCase() === 'industry'){
		iconObject.src = 'avatar/role-icons/industry.png';
	}else{
		iconObject.src = 'avatar/role-icons/other.png';
	}
